...
class FCN(nn.Module):
    ...
    def update_task(self,new_task, new_classes):
        ...
        if self.task == None or self.task == "rotation" or self.task == "jigsaw" or self.task=='frame_order':
    ...
    def forward(self, x):
        ...
        assert self.task== None or self.task=='segmentation' or self.task=='rotation' or self.task=='jigsaw' or self.task=='frame_order', "Not recognized task"
